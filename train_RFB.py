...
from data import VOCroot, VOC_300, VOC_512, CLASSES, VOCDetection, detection_collate, ImageAugment
...
parser.add_argument('-d', '--dataset', default='SDYY',
                    help='2012 of VOC or SDYY dataset')
...
parser.add_argument('-max', '--max_epoch', default=800, type=int, help='max epoch for retraining')
...
# image augment object
augment = ImageAugment(img_size, rgb_mean)
# image train and valid data set object
dataset = VOCDetection(VOCroot, train_sets, CLASSES, augment)
num_classes = len(dataset.classes)
batch_size = args.batch_size
weight_decay = 0.0005
gamma = 0.1
momentum = 0.9
net = build_net('train', img_size, num_classes)
print(net)
...
def train():
    ...
    print('Training', args.version, 'on', args.dataset)
    step_index = 0
