...
def build_net(phase, size=300, num_classes=21):
    ...
    vgg_con, extra_layers_con, (loc_layers_con, conf_layers_con)=multibox(size, vgg(base[str(size)], 3),add_extras(size, extras[str(size)], 1024),mbox[str(size)], num_classes)

    return RFBNet(phase, size, vgg_con, extra_layers_con, (loc_layers_con, conf_layers_con), num_classes)
